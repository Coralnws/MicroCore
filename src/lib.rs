...
#[derive(Debug)]
pub struct MicroCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MicroCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MicroCore processing");
    
    let mut processor = MicroCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MicroCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MicroCoreProcessor::new(false);
